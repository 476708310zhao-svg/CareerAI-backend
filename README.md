...
后端、后台和部署相关开发使用上面这个目录。微信开发者工具当前打开的小程序项目目录是：

```text
C:\Users\admin\Desktop\求职小程序\求职小程序
```

后续开发前请先确认本次要改的是后端项目还是小程序项目，避免误扫或误改其它仓库。
...
GitHub Actions 已新增 `.github/workflows/test.yml`，在 push/PR 到 `main` 时运行：
