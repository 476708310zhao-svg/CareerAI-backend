// utils/mock-data.js — development-only demo fixtures
// Production pages should access this only through utils/demo-data.js when
// ENABLE_DEMO_FALLBACK is explicitly enabled.
...
const NEWS_DETAIL_CONTENT = {
  n1: [
    '字节跳动 2026 春招面向海外留学生开放技术、产品、运营、设计等多个方向，适合计划回国或关注国际化业务的同学重点跟进。',
    '',
    '重点岗位包括后端开发、前端开发、客户端、算法工程师、数据分析、产品经理、商业化运营和内容运营。技术岗通常会考察算法基础、项目深度和工程实践，产品/运营岗更看重业务理解、数据意识和跨团队协作。',
    '',
    '投递建议：',
    '1. 尽早完成网申，热门岗位往往会滚动筛选。',
    '2. 简历里突出和 TikTok、抖音、飞书、商业化、推荐系统相关的项目关键词。',
    '3. 技术岗准备 150 道左右中等难度算法题，并复盘 2-3 个能深挖的项目。',
    '4. 非技术岗准备产品拆解、增长分析和行为面试案例。'
  ],
  n2: [
    'Google 2026 New Grad 岗位已陆续开放，常见方向包括 Software Engineer、Product Manager、Data Scientist、UX Designer 和部分硬件相关岗位。',
    '',
    'Google 的招聘节奏通常是 rolling basis，越早投递越容易进入筛选池。SWE 岗位重点考察算法、数据结构、代码质量和沟通方式；PM/DS 岗位会更关注问题拆解、数据判断和产品意识。',
    '',
    '准备清单：',
    '1. SWE 优先刷数组、哈希表、图、动态规划、二分和树相关题型。',
    '2. 行为面试准备 Googleyness、Leadership、团队协作和失败复盘案例。',
    '3. 简历项目要写清楚规模、技术栈、个人贡献和量化结果。',
    '4. 如果需要 sponsorship，投递前确认岗位页面说明。'
  ],
  n3: [
    '腾讯海外招聘专场覆盖北美、欧洲、新加坡等地区，技术类岗位竞争较高，但对有游戏、云计算、社交、金融科技背景的留学生较友好。',
    '',
    '重点业务方向包括游戏研发、微信生态、腾讯云、广告推荐、金融科技和国际化产品。技术岗一般会有笔试或在线测评，随后进入多轮技术面和 HR 面。',
    '',
    '投递建议：',
    '1. 先确定目标事业群和业务方向，避免一份简历投所有岗位。',
    '2. 游戏/客户端方向突出性能优化、图形渲染或跨端经验。',
    '3. 云计算/后台方向突出分布式系统、数据库、缓存和稳定性经验。',
    '4. 面试前熟悉腾讯核心产品和业务场景。'
  ],
  n4: [
    'Amazon 2026 暑期实习申请进入关键窗口，SDE Intern 竞争激烈，建议尽快投递并同步准备 Online Assessment 与 Leadership Principles。',
    '',
    'SDE 实习通常包含在线测评和一轮虚拟面试。OA 以算法题为主，面试会同时考察 coding 和行为面试。Amazon 特别重视 Leadership Principles，回答时要用具体故事证明你的 ownership、customer obsession 和 dive deep 能力。',
    '',
    '准备重点：',
    '1. 刷 Amazon 高频题，重点覆盖数组、字符串、哈希表、树、图和堆。',
    '2. 准备 6-8 个 STAR 案例，每个案例对应 1-2 条 Leadership Principles。',
    '3. 项目讲解要强调你做了什么决策、遇到什么问题、结果如何量化。',
    '4. 投递后保持邮箱和申请系统状态更新。'
  ],
  n5: [
    '华为海外留学生招聘持续关注 AI、芯片、操作系统、通信、智能驾驶等硬科技方向，部分高潜人才可进入高薪专项计划。',
    '',
    '适合人群包括有顶会论文、科研项目、工程落地经验或竞赛成绩的硕博同学。相比普通校招，这类专项更看重技术深度、长期潜力和解决复杂问题的能力。',
    '',
    '准备建议：',
    '1. 简历突出论文、专利、竞赛、科研产出和工程落地指标。',
    '2. 准备一份可深挖的技术项目讲解，覆盖背景、难点、方案和结果。',
    '3. 提前了解目标实验室或业务团队方向。',
    '4. 面试中少讲泛泛技术栈，多讲你解决问题的方法。'
  ],
  n6: [
    'STAR 法则是行为面试中最稳定的回答框架，尤其适合回答冲突处理、领导力、失败复盘、压力管理和团队合作类问题。',
    '',
    '结构拆解：',
    'S Situation：交代背景，让面试官知道问题发生在什么场景。',
    'T Task：说明你的职责和目标，不要把团队任务说成个人贡献。',
    'A Action：重点描述你采取的行动，这是回答中最重要的部分。',
    'R Result：用数据、反馈或最终影响收尾。',
    '',
    '练习建议：准备 8 个高质量案例，每个控制在 2 分钟左右。同一个案例可以复用到不同问题，但要调整重点。'
  ],
  n7: [
    '简历里最容易被忽略的部分，是把“我做过什么”改成“我带来了什么结果”。量化成果能让 HR 和面试官更快判断你的能力边界。',
    '',
    '改写示例：',
    '普通写法：优化了系统性能。',
    '更好写法：通过 Redis 缓存和 SQL 索引优化，将接口响应时间从 800ms 降至 120ms。',
    '',
    '可量化维度：',
    '1. 性能：响应时间、吞吐量、稳定性。',
    '2. 业务：用户数、转化率、收入、留存。',
    '3. 效率：节省人力、自动化比例、处理时长。',
    '4. 规模：数据量、并发数、服务用户数。'
  ],
  n8: [
    'System Design 面试不是单纯画架构图，而是考察你是否能在模糊需求下做合理取舍。',
    '',
    '推荐四步法：',
    '1. 需求澄清：先问清楚用户规模、核心功能、读写比例和一致性要求。',
    '2. 高层设计：画出 client、gateway、service、cache、database、queue 等核心模块。',
    '3. 详细设计：解释数据模型、API、核心流程和关键算法。',
    '4. 扩展优化：讨论缓存、分库分表、限流、监控、容灾和成本。',
    '',
    '常见题包括短链接、Feed 流、聊天系统、通知系统、Rate Limiter 和文件存储系统。'
  ],
  n9: [
    'ATS 会根据职位描述中的关键词、格式结构和简历可解析性进行初筛。很多简历不是能力不够，而是没有被系统正确识别。',
    '',
    '优化重点：',
    '1. 使用标准标题：Education、Experience、Projects、Skills。',
    '2. 避免复杂表格、图片、图标和过度排版。',
    '3. 从 JD 中提取关键词，并自然写进技能和项目描述。',
    '4. 每段经历用动词开头，并尽量加入量化结果。',
    '5. 文件名建议使用“姓名_岗位_学校.pdf”。'
  ],
  n10: [
    '英文面试里，流畅不等于语速快。更重要的是结构清楚、表达具体、遇到不会的问题也能展示思考过程。',
    '',
    '常用表达：',
    '1. Let me think about this for a moment.',
    '2. My approach would be to...',
    '3. The trade-off here is...',
    '4. To clarify, are we optimizing for latency or scalability?',
    '5. I have not used that exact tool, but I solved a similar problem by...',
    '',
    '建议把自我介绍、项目讲解、失败经历、冲突处理和为什么选择公司提前写成英文提纲，再进行口头练习。'
  ],
  n11: [
    'CS 硕士在美国科技岗中的起薪仍保持较高水平，尤其是 AI、数据基础设施、后端平台和机器学习方向。',
    '',
    '常见区间参考：',
    ...
    '',
    '影响薪资的关键因素包括城市、公司层级、岗位方向、是否有实习经历、项目深度和面试表现。对留学生来说，sponsorship 友好度也会影响可选机会范围。'
  ],
  n12: [
    '数据分析师岗位需求增长明显，企业越来越需要能把业务问题、数据处理和可视化表达连接起来的人才。',
    '',
    '高频技能组合：',
    '1. SQL：几乎是所有数据岗的基础门槛。',
    '2. Python：用于数据清洗、自动化和基础建模。',
    '3. Tableau / Power BI：用于可视化和业务汇报。',
    '4. A/B Testing：互联网和增长岗位尤其高频。',
    '5. 沟通能力：能把数据结论转化成业务建议。',
    '',
    '准备方向：刷 SQL 题、做 2 个完整业务分析项目，并练习用英文讲清楚分析过程。'
  ],
  n13: [
    '2026 留学生就业趋势中，回国发展比例继续上升。主要原因包括国内岗位机会恢复、落户政策吸引、家庭因素和海外签证不确定性。',
    '',
    '热门城市包括上海、北京、深圳、杭州和广州。互联网、金融、咨询、新能源、智能制造和 AI 相关岗位仍是主要流向。',
    '',
    '回国求职建议：',
    '1. 提前完成教育部学历认证准备。',
    '2. 简历同时准备中文和英文版本。',
    '3. 关注留学生专场和提前批，不要只等秋招主批。',
    '4. 如果目标是一线城市落户，要同步确认社保和公司资质要求。'
  ],
  n14: [
    'STEM OPT 是美国留学生延长合法工作时间的重要路径。基础 OPT 通常为 12 个月，符合 STEM 专业要求后可申请额外 24 个月延期。',
    '',
    '核心要求：',
    '1. 雇主必须加入 E-Verify。',
    '2. 岗位需要与 STEM 学位直接相关。',
    ...
    '4. 申请需在 OPT 到期前完成提交。',
    '',
    '注意事项：换工作、地址变化和雇主信息变化都需要及时更新 SEVP 记录。政策细节可能变化，重要节点应以学校 DSO 和 USCIS 官方说明为准。'
  ],
  n15: [
    'H1B 抽签改革后，抽签逻辑更强调“一人一签”，减少通过多个注册提高概率的空间，对真实求职者相对更公平。',
    '',
    '对留学生的影响：',
    '1. 多雇主重复注册带来的优势下降。',
    '2. 有真实 offer 的申请人中签环境更透明。',
    '3. OPT/STEM OPT 时间规划仍然非常重要。',
    '',
    '备选路径包括继续使用 STEM OPT、选择 Day 1 CPT、申请 O1、通过跨国公司 L1 路径，或考虑加拿大、新加坡、英国等地机会。签证策略建议尽早与雇主 HR 或移民律师确认。'
  ],
  n16: [
    '留学生回国落户政策因城市而异，常见评估维度包括学校排名、学历层次、回国时间、社保缴纳、用人单位资质和劳动合同。',
    '',
    '城市差异：',
    '上海更关注院校排名、社保基数和回国后首份工作时间；北京通常要求单位有落户指标；深圳、杭州、广州整体更友好，办理周期也相对更短。',
    '',
    '准备清单：',
    '1. 教育部学历认证。',
    '2. 护照、签证、出入境记录。',
...
function enrichNewsFeedItem(item) {
  return Object.assign({}, item, {
    content: (NEWS_DETAIL_CONTENT[item.id] || [item.title, '', item.desc || '']).join('\n')
  });
}
