...
Page({
  ...
  startAiInterview() {
    ...
    wx.navigateTo({
      url: `/package-ai/pages/interview-dialog/interview-dialog?autoQuestion=${encodeURIComponent(title)}`
    });
  },
  ...
  onShareAppMessage() {
    return {
      ...
      path: `/package-content/pages/experience-detail/experience-detail?id=${this.data.expId}`
    };
  },
