...
const MODULE_ROUTES = {
  ...
  applications: '/package-user/pages/applications/applications',
  interview:    '/package-ai/pages/interview-setup/interview-setup',
  career_plan:  '/package-career/pages/career-planner/career-planner',
  agencies:     '/pages/agencies/agencies',
  campus:       '/package-content/pages/campus/campus',
  salary:       '/package-career/pages/salary/salary',
};
const MODULE_ICONS = {
