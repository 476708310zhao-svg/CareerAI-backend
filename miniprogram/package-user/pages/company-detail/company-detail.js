...
Page({
  ...
  goToExperienceDetail(e) {
    ...
    if (exp && exp.isAI && exp.content) {
      ...
      wx.navigateTo({ url: '/package-content/pages/experience-detail/experience-detail?id=aiTemp' });
    } else {
      wx.navigateTo({ url: '/package-content/pages/experience-detail/experience-detail?id=' + id });
    }
  },
