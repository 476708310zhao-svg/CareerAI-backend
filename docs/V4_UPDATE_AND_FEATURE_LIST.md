...
- ✅ 首页已重构为求职工作台
- ✅ 已拆分 Today 计划、核心工具、推荐岗位和校招日历瀑布流组件；求职情报已从首页移至资源中心
...
- ✅ 资源中心聚合面试题库、STAR 案例、薪酬查询、公司情报、OA 题库、AI 模拟面试、技能路径、职业洞察、校招日历、求职资讯、机构测评和使用指南
- ✅ 校招日历保留为完整二级页面；首页以双列瀑布流展示当日更新，原岗位推荐页保留为二级搜索与推荐入口
