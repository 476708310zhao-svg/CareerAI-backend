...
| 今日校招信息更新 | 需要兼顾机会密度与浏览效率 | 首页改为最多 8 条双列瀑布流，完整内容进入校招日历 |
...
- `home-campus-updates`：今日校招双列瀑布流及完整校招入口。
...
| 今日校招 | `getCampusList` 与本地缓存，首页最多展示 8 条双列瀑布流卡片 |
...
- 推荐岗位保持紧凑列表，今日校招改为双列瀑布流，提升机会密度与信息扫描效率。
